...
*/
#define Tx_mode         // for RF remote 
//#define Rx_mode       // for RF switching ckt
...
#define VAL_MCSM1            0x2B//0x30//default If RSSI below threshold unless currently receiving packet  // ronak
